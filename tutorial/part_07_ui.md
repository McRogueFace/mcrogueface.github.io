...
- Building a scrollable message log with Frame and Captions
- Displaying dungeon level information
- Color-coding messages by type (damage, healing, info)
- Updating UI elements when game state changes
- Organizing UI layout and positioning
...
- **Damage to player**: Red tones (warning)
- **Damage to enemies**: Neutral gray
- **Healing/victories**: Green (positive)
- **System info**: Blue (neutral)
...
- **MessageLog class**: Manages a scrolling, color-coded message display
- **HealthBar class**: Visual HP bar with color-coded thresholds
- **StatsPanel class**: Displays dungeon level and player stats
- **Layout constants**: Organized screen regions for UI elements
- **update_ui()**: Centralized UI refresh function
- **Message colors**: Predefined colors for different message types
